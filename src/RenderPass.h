...
class Vulkan::PipelineOptions::RenderPass {
	public:
		...
		/**
		 * @brief Creates a RenderPass given its Subpass(es) and its BoundAttachmentDescription(s).
		 ...
		 *			Moreover each bound attachment should have a unique index, and, given N attachments are used, indexes should go from 0 to N-1. BoundAttachmentDescription(s) generated by AttachmentDescription::prepareAttachments follow this property.
		 * 
		...
		RenderPass(const LogicalDevice& virtualGpu, const std::vector<RenderPassOptions::AttachmentDescription::BoundAttachmentDescription>& attachments, const S&... subpasses) : virtualGpu{ virtualGpu } {
